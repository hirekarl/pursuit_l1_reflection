# Case Study: Elevator Advocate
## Civic Accountability at Scale

### 🧐 The "Industrialist" Bet
**The Neglected Vertical:** NYC Rent-stabilized tenants (specifically seniors and the mobility-impaired).
**The Friction:** The "Lethal Information Gap." Landlords know when elevators are broken but don't report them; the city (311) relies on residents to report, but residents are often overwhelmed or lack the digital literacy to navigate official portals.
**Why Enterprise Fails Here:** There is no profit motive for big tech to solve elevator outages in the Bronx. Government software is notoriously slow and inaccessible.

### ⚡ Builder Advocacy in Action
*   **Velocity:** Integrated NYC Open Data (SODA API) and Leaflet maps into a Django/React stack in under a week.
...
- **Day 1:** NYC Open Data (SODA) API integration.
